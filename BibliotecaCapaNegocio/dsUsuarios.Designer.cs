...
namespace BibliotecaCapaNegocio {
    ...
    public partial class dsUsuarios : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            private global::System.Data.DataColumn columnNivelDesc;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public global::System.Data.DataColumn NivelDescColumn {
                get {
                    return this.columnNivelDesc;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsuariosRow AddUsuariosRow(int id, string Username, string Clave, byte Nivel, string NivelDesc) {
            ...
            internal void InitVars() {
                ...
                this.columnNivelDesc = base.Columns["NivelDesc"];
            }
            ...
            private void InitClass() {
                ...
                this.columnNivelDesc = new global::System.Data.DataColumn("NivelDesc", typeof(string), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnNivelDesc);
                ...
                this.columnNivelDesc.ReadOnly = true;
                this.columnNivelDesc.MaxLength = 19;
            }
        ...
        public partial class UsuariosRow : global::System.Data.DataRow {
            ...
            public string NivelDesc {
                get {
                    try {
                        return ((string)(this[this.tableUsuarios.NivelDescColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'NivelDesc\' de la tabla \'Usuarios\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tableUsuarios.NivelDescColumn] = value;
                }
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsNivelDescNull() {
                return this.IsNull(this.tableUsuarios.NivelDescColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetNivelDescNull() {
                this[this.tableUsuarios.NivelDescColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace BibliotecaCapaNegocio.dsUsuariosTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("NivelDesc", "NivelDesc");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Usuarios] WHERE (([id] = @Original_id) AND ([Username] = @Original_U" +
                "sername) AND ([Clave] = @Original_Clave) AND ([Nivel] = @Original_Nivel))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Usuarios] ([id], [Username], [Clave], [Nivel]) VALUES (@id, @Username, @Clave, @Nivel);
SELECT id, Username, Clave, Nivel, CASE WHEN Nivel = 1 THEN 'Super Administrador' WHEN Nivel = 2 THEN 'Administrador' ELSE 'Usuario Comun' END AS NivelDesc FROM Usuarios WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Usuarios] SET [id] = @id, [Username] = @Username, [Clave] = @Clave, [Nivel] = @Nivel WHERE (([id] = @Original_id) AND ([Username] = @Original_Username) AND ([Clave] = @Original_Clave) AND ([Nivel] = @Original_Nivel));
SELECT id, Username, Clave, Nivel, CASE WHEN Nivel = 1 THEN 'Super Administrador' WHEN Nivel = 2 THEN 'Administrador' ELSE 'Usuario Comun' END AS NivelDesc FROM Usuarios WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        id, Username, Clave, Nivel, CASE WHEN Nivel = 1 THEN \'Super Adminis" +
                "trador\' WHEN Nivel = 2 THEN \'Administrador\' ELSE \'Usuario Comun\' END AS NivelDes" +
                "c\r\nFROM            Usuarios\r\nWHERE        (Username LIKE \'%\' + @Filtro + \'%\')";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Filtro", global::System.Data.SqlDbType.VarChar, 15, global::System.Data.ParameterDirection.Input, 0, 0, "Username", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(dsUsuarios.UsuariosDataTable dataTable, string Filtro) {
        ...
        public virtual dsUsuarios.UsuariosDataTable GetData(string Filtro) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((Filtro == null)) {
                throw new global::System.ArgumentNullException("Filtro");
            }
        ...
        public virtual int Delete(int Original_id, string Original_Username, string Original_Clave, byte Original_Nivel) {
        ...
        public virtual int Insert(int id, string Username, string Clave, byte Nivel) {
        ...
        public virtual int Update(int id, string Username, string Clave, byte Nivel, int Original_id, string Original_Username, string Original_Clave, byte Original_Nivel) {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((byte)(Original_Nivel));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Username, string Clave, byte Nivel, int Original_id, string Original_Username, string Original_Clave, byte Original_Nivel) {
            return this.Update(Original_id, Username, Clave, Nivel, Original_id, Original_Username, Original_Clave, Original_Nivel);
        }
    }
